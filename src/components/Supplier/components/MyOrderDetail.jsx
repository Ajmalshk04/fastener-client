...
const OrderStatus = ({ status }) => {
  const colors = {
    ...
    SHIPPED: "bg-yellow-500/10 text-yellow-700",
  ...
  return (
    <Badge className={`${colors[status]} font-medium px-2.5 py-0.5`}>
      ...
      <Card className="shadow-sm border-0">
        <CardHeader className="space-y-4">
          <Button
            variant="ghost"
            size="sm"
            onClick={() => navigate("/supplier/dashboard/my-orders")}
            className="w-fit"
          >
        ...
        <CardContent className="space-y-8">
          ...
          <div className="space-y-6">
            <h3 className="font-semibold text-lg">Update Project Status</h3>
            <Form {...form}>
              <form
