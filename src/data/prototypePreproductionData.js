    ...
    sections: [
      {
        ...
        content: [
          ...
          {
            heading: "Scalable Manufacturing Processes",
            list: [
              "Aluminum Extrusions",
              "Die Casting",
              "CNC Machining",
      ...
      {
        title: "Start Manufacturing Your Prototype Today",
        content: [
          {
            heading: "Prototyping Purpose",
            text: [
              "Prototyping is often used by design teams and engineers to create the first physical parts of their designs. Design teams use prototyping as a tool to validate their design ideas, iterate on concepts and create alignment amongst various teams, prospective customers, and stakeholders for their projects.",
              "Submit the relevant part drawings, 3D files, and other information by clicking on the button below. We’ll make sure that it gets processed promptly, and that you receive a quote as soon as possible.",
            ],
            button: {
              text: "Get a Quote",
              href: "#quote",
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            ...
            text: [
              "MJF 3D Printing is the ideal 3D Printing process for producing mono-color parts using materials like nylon. MJF 3D Printing process can also produce multi-color parts. MJF Parts have good tolerance and a grainy surface finish.",
            ],
          },
          {
            heading: "SLS 3D Printing Services",
            text: [
              "SLS 3D Printing is the ideal 3D printing process for manufacturing mono-color parts using Nylon. Just like the MJF 3D Printing process, SLS parts have a grainy surface finish.",
            ],
          },
          {
            heading: "FDM 3D Printing Services",
            text: [
              "FDM 3D Printing is the ideal 3D Printing Process for manufacturing mono-color parts where the dimensional tolerance isn’t high. FDM 3D Printing Process can be used with a variety of materials like PLA, ABS, Nylon, and PolyCarbonate.",
            ],
          },
          {
      ...
      },
      {
        ...
        content: [
          {
            heading: "Urethane Casting Overview",
            text: [
      ...
      {
        title: "Low-Volume Precision Machining",
        content: [
          {
      ...
      {
        title: "Low-Volume Sheet Metal Fabrication",
        content: [
          {
      ...
      {
        title: "Low-Volume Aluminum Extrusions",
        content: [
          {
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            ...
            text: [
              "Once we receive your purchase order we’ll do a formal Design For Manufacturability (DFM) review with you and your team to ensure the design is optimized for manufacturing. This step will help prevent issues, reduce production time, and ensure the prototype meets your design and performance criteria.",
            ],
          },
          {
