export const forgingData = {
    title: "Forging",
    lead: "The forging manufacturing process utilizes metal that is hammered, pressed, or rolled under intense, localized pressure. The parts are shaped into high-strength components known as forgings.",
    sections: [
      {
        title: "Overview",
        content: [
          {
            heading: "Forged Parts Benefits",
            text: [
      ...
      {
        title: "Forged Components for a Variety of Industries and Applications",
        content: [
          {
            heading: "Post-Processing and Quality",
            text: [
        ...
        content: [
          {
            ...
            text: [
              "Xofah provides a full suite of services focused on reducing turnaround time and improving efficiency and value. Xofah delivers projects that are more cost-effective and are brought to market sooner.",
            ],
            button: {
              text: "Play Video",
              href: "#video",
      ...
      {
        title: "Get a Quote for Forged Components",
        content: [
          {
            heading: "Comprehensive Services",
            text: [
              "Xofah is your immediate and reliable solution for complete end-to-end manufacturing and supply chain services. We provide:",
            ],
            list: [
          ...
          },
          {
            ...
            text: [
              "Experience the difference Xofah makes in your manufacturing process. Request a quote today for forging services or any other manufactured component.",
            ],
            button: {
