    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          {
            list: [
              "Advanced CNC machining, injection molding, sheet metal fabrication, 3D printing, and urethane casting.",
              "Specialized services like overmolding, insert molding, and die casting for complex components.",
              "Secondary operations including anodizing, powder coating, electroplating, and heat treatment.",
              "Rapid prototyping with delivery in as little as five days, supporting industries like medical, robotics, and lighting.",
              "End-to-end solutions for energy projects, including wind turbine components, solar mounts, and oil & gas infrastructure."
            ]
          },
          {
            text: [
          ...
          },
          {
            list: [
              ...
              },
              {
                ...
                description: "Simplifies global shipping with multi-modal transport and customs support, reducing costs and ensuring timely delivery across continents."
              },
              {
                label: "Managed Supply Chain",
                description: "Consolidates vendor management into a single, agile solution, giving manufacturers access to top-tier global capacity without the complexity."
              }
            ]
          },
          {
      ...
      },
      {
        ...
        content: [
          ...
          {
            list: [
              "10,000+ vetted suppliers worldwide, enhancing capacity utilization by 40%.",
              "Efficiency gains of up to 80% through planning and project management tools.",
              "Financial support via working capital loans and invoice discounting, helping suppliers grow.",
              "Support for industries like renewable energy (wind and solar), oil & gas, and lighting with tailored components."
            ]
          },
          {
            text: [
      ...
      },
      {
        ...
        content: [
          ...
          {
            list: [
              "On-site inspections by certified QA specialists at every production stage.",
              "Full traceability with documentation like CoCs, material certifications, and dimensional reports.",
              "Global quality expertise in FMEA, APQP, PPAP, SPC, and MSA.",
              "Additional quality checks for ZMI customers upon warehouse arrival."
            ]
          }
        ]
      },
      {
        ...
        content: [
          ...
          {
            list: [
              "Over 40,000 customers served with real-time manufacturing data.",
              "Trusted by industry leaders like General Electric and passenger vehicle OEMs.",
              "Flexible solutions for prototyping, production, and supply chain management."
            ]
          },
          {
