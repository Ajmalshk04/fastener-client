    ...
    sections: [
      {
        ...
        subsections: [
          ...
          {
            title: "Secondary Operations, Materials & Surface Finishes for CNC Machined Components",
            content: [
              { subheading: "Secondary Operations & Finishing Processes", text: "Once production components are CNC machined, they are subjected to one or more finishing processes to remove the any deformities and achieve tolerances.", additional: "Some of the secondary operations and finishing processes offered:" },
            ],
            list: [
              { name: "Surface Finishing", description: "Phosphating, blasting, Anodising, Zn & Zn-Ni Plating, Passivation, Alodine, Abrasive blasting, Cd, etc." },
              { name: "Heat Treatment", description: "Nitriding, Stress relieving by using hardening, Nitriding, and Carburising" },
              { name: "Assembly & Integration Services" },
              "… and many more"
            ]
          },
          {
          ...
          },
          {
            ...
            content: [
              "Once we receive your purchase order, we’ll do a formal Design For Manufacturability (DFM) review with you and your team to ensure the design is optimized. This step will help prevent issues, reduce production time, and ensure the CNC machined components meet your design and performance criteria.",
              "Optimizing the design through a DFM is an often overlooked step; addressing this before manufacturing will save time and costs as well as enabling you to get to market faster."
            ]
          },
          {
            title: "FAIR Approval",
      ...
      },
      {
        ...
        subsections: [
          ...
          {
            title: "Custom Sourced Materials",
            content: [
          ...
          },
          {
            ...
            list: [
              { name: "As-Milled", description: "The finish option with the quickest turnaround. Parts are left with visible tool marks and potentially sharp edges and burrs, which can be removed upon request. Surface finish is comparable to 125 uin Ra finish." },
              { name: "Bead Blast", description: "The part surface is media blasted, typically using glass bead, to produce a smooth, matte appearance." },
              { name: "Anodized (Type II Or Type III)", description: "Type II creates a corrosion-resistant finish. Parts can be anodized in different colors—clear, black, red, and gold are most common—and is usually associated with aluminum. Type III is thicker and creates a wear-resistant layer in addition to the corrosion resistance seen with Type II." },
              { name: "Powder Coat", description: "This is a process where powdered paint is sprayed onto a part which is then baked in an oven. This creates a strong, wear- and corrosion-resistant layer that is more durable than standard painting methods. A wide variety of colors are available to create the desired aesthetic." },
              { name: "Custom", description: "Don’t see the finish you need? Submit an RFQ and we’ll look into a finishing process for you." }
            ]
          },
          {
            title: "CNC Milling Tolerances & Standards",
            table: {
              headers: ["Description", "General Tolerance or Standard"],
              rows: [
          ...
          {
            title: "Overview: What is CNC Milling?",
            content: [
        ...
        subsections: [
          ...
          },
          {
            ...
            list: [
              ...
              { name: "Anodized (Type II Or Type III)", description: "Type II creates a corrosion-resistant finish. Parts can be anodized in different colors—clear, black, red, and gold are most common—and is usually associated with aluminum. Type III is thicker and creates a wear-resistant layer in addition to the corrosion resistance seen with Type II." },
              { name: "Powder Coat", description: "This is a process where powdered paint is sprayed onto a part which is then baked in an oven. This creates a strong, wear- and corrosion-resistant layer that is more durable than standard painting methods. A wide variety of colors are available to create the desired aesthetic." },
              { name: "Custom", description: "Don’t see the finish you need? Submit an RFQ and we’ll look into a finishing process for process for your custom lathe work." }
            ]
          },
          {
            ...
            list: [
              ...
              { name: "Scalability", description: "CNC Machining is perfect for production of 1-10,000 CNC machined parts." }
            ]
          },
          {
            title: "CNC General Tolerances",
            table: {
          ...
          {
            title: "Overview: What is CNC Turning?",
            content: [
              { subheading: "The Basics Of CNC Lathes", text: "A CNC lathe machine, also called live tooling lathes, is ideal for cutting any symmetrical cylindrical or spherical parts. Characteristically, a lathe spins a workpiece on a vertical or horizontal axis, while a fixed shaping instrument moves around it on a more or less linear path. The act of cutting a workpiece on a CNC lathe is called turning." },
              { subheading: "How CNC Turning Works", text: "CNC lathes use a subtractive method to create the desired shape. With the G-Code created, a blank bar of stock material is loaded into the chuck of the lathe's spindle. The chuck holds the workpiece in place while the spindle spins. When the spindle is up to speed, a stationary cutting tool is brought into contact with the workpiece to remove material until the desired geometry is achieved.", additional: "There are many operations that can be performed on a live tooling lathe, including facing, threading, knurling, drilling, boring, reaming, and taper turning. Different operations require tool changes and can increase cost and set-up time. When all machining operations are completed, the part is cut from the stock for further post-processing. The CNC lathe is then ready to repeat the operation with little-to-no set-up time in between." },
              { subheading: "Types Of CNC Lathes", text: "There are many types of lathes, but the most common are 2-axis CNC lathes and Swiss-type lathes. Swiss-type lathes are unique in that stock material is fed through a guide bushing, allowing the tool to cut nearer to the point of support, which makes them particularly useful for long, slender CNC lathe parts and micromachining. Some Swiss-type lathes also come equipped with a second tool head that operates as a CNC mill, allowing them to perform multiple machining operations without having to move the workpiece to a different machine. This makes Swiss-type lathes extremely cost-effective for complex turned parts with CNC lathe services." },
              { subheading: "Benefits Of CNC Turning", text: "Like CNC mills, CNC lathes can be easily set up for high repeatability, which makes them great for everything from rapid prototyping to low and high-volume production. Multi-axis CNC turning centers and Swiss-type lathes allow for multiple machining operations in one machine. making them a cost-effective option for complex geometries that would otherwise require multiple machines or tool changes in a traditional CNC mill." }
            ]
          }
        ]
      },
      {
        ...
        subsections: [
          ...
          {
            title: "Wire EDM Machining Finishes Available",
            list: [
              { name: "Standard Finish (as-milled)", description: "The finish option with the quickest turnaround. Parts are left with visible tool marks and potentially sharp edges and burrs, which can be removed upon request. Surface finish is comparable to 125 uin Ra finish." },
              { name: "Bead Blast", description: "The part surface is left with a smooth, matte appearance." },
              { name: "Tumbled", description: "This is a batch-based process that tumbles vibrating media to remove sharp edges and burrs on machined parts. Tumbling can remove machine marks on exterior surfaces. Parts over 8” may require a manual review." },
              { name: "Anodized (Type II or Type III)", description: "Type II (MIL-A-8625/MIL-PRF-8625, Type II) creates a corrosion-resistant finish. Parts can be anodized in different colors—clear, black, red, and gold are most common—and is usually associated with aluminum. Type III (MIL-A-8625/MIL-PRF-8625, Type III, Class 1/2 \"hardcoat\") is thicker and creates a wear-resistant layer in addition to the corrosion resistance seen with Type II." },
              { name: "Titanium Anodize", description: "A surface finish for titanium per AMS-2488 Type 2 specification. Also called Tiodize, this finish increases fatigue strength and the wear resistance of a part. Titanium anodized parts are common in aerospace and medical device manufacturing. Non-pigmented titanium anodize finishes will dull shine." },
              { name: "PTFE Impregnated Hard Anodize", description: "A hard coat anodize process that embeds PTFE to create a self-lubricating, dry contact surface with Type 3 hard coat’s protective properties. This finish can be used on aluminum alloys or titanium and increases the service life of the product. This finish conforms to the AMS-2482 Type 1 Hard Coat Anodizing with Teflon (Non-Dyed)." },
              { name: "Chem Film", description: "Provides corrosion resistance and good conductivity properties. Can be used as a base for paint. Can leave surface yellow/gold. Adds very little thickness, about 0.00001”-0.00004”. Chem film will conform to MIL-DTL-5541, TYPE I/II." },
              { name: "Passivation", description: "Improves corrosion resistance for 200 and 300 series and precipitation hardened corrosion-resistant steels. Thickness is negligible, about 0.0000001”. Conforms to ASTM A967, AMS-QQ-P-35, MIL-STD-171, ASTM A380, or AMS 2700." },
              { name: "Powder Coat", description: "This is a process where powdered paint is sprayed onto a part that is then baked in an oven. This creates a strong, wear- and corrosion-resistant layer that is more durable than standard painting methods. A wide variety of colors are available to create the desired aesthetic." },
              { name: "Electropolishing", description: "An electrochemical process cleans steel parts to reduce corrosion and improve appearance, by making the metal brighter. Removes about 0.0001”-0.0025” of the metal. Conforms to ASTM B912-02." },
              { name: "Electroless Nickel Plating", description: "Provides uniform nickel coating which offers protection from corrosion, oxidation, and wear on irregular surfaces. The finished part will be brighter. Thickness starts at .0001”. Conforms to MIL-C-26074." },
              { name: "Silver Plating", description: "Silver offers high solderability and electrical conductivity but is susceptible to tarnish. Conforms to AMS QQ-S-365D. Thickness is about 0.00002” - 0.0003.”" },
              { name: "Gold Plating", description: "Gold Plating provides good corrosion and tarnish resistance with excellent solderability. Default application specification is MIL-G-45204 and ASTM B488, CLASS 00, 0, OR 1. Thickness is about 0.00002\" - 0.00005.\"" },
              { name: "Zinc Plating", description: "Provides uniform zinc coating which offers protection from corrosion, oxidation, and wear on irregular surfaces. Conforms to ASTM B633-15." }
            ]
          }
        ]
      },
      {
        ...
        subsections: [
          ...
          {
            title: "Applications of Medical CNC Machining",
            content: [
          ...
          {
            title: "Medical CNC Machining Materials",
            content: [
